...
type GreeterClient interface {
	...
	// 普通RPC使用metadata
	UnarySayHelloSay(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *greeterClient) UnarySayHelloSay(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/pb.Greeter/UnarySayHelloSay", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	// 普通RPC使用metadata
	UnarySayHelloSay(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedGreeterServer) UnarySayHelloSay(context.Context, *HelloRequest) (*HelloResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnarySayHelloSay not implemented")
}
...
func _Greeter_UnarySayHelloSay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).UnarySayHelloSay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Greeter/UnarySayHelloSay",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).UnarySayHelloSay(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UnarySayHelloSay",
			Handler:    _Greeter_UnarySayHelloSay_Handler,
		},
	},
